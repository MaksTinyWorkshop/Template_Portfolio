...
PortFolio Max est une application web moderne conçue pour présenter un portfolio professionnel complet. Elle combine un site vitrine public élégant avec un système d'administration robuste permettant la gestion complète du contenu.
...
**Pages** : 8 routes publiques + 3+ routes admin
...
- `src/resources/content.tsx` : Contenu du site
- `src/resources/config/` : Configuration Once UI
