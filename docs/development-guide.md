...
2. **Manuellement**
   ...
   touch data/posts/mon-nouveau-post.mdx
   ```
   ...
   **Structure du fichier** :
   ...
   Contenu du post en Markdown/MDX...
   ```
...
2. **Manuellement**
   ...
   **Structure** :
   ...
   images:
     - /images/projects/projet-cover.jpg
   team:
     - name: "Votre Nom"
       role: "Développeur"
   tags:
...
**Fichier principal** : `src/resources/content.tsx`
...
**Fichier** : `src/resources/config/once-ui.config.js`
...
**Fichier** : `src/resources/icons.ts`
